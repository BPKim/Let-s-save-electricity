...
_0x0:
	.DB  0x68,0x6F,0x75,0x72,0x3A,0x20,0x25,0x64
	.DB  0x20,0x6D,0x69,0x6E,0x75,0x74,0x65,0x3A
	.DB  0x20,0x25,0x64,0x20,0x73,0x65,0x63,0x6F
	.DB  0x6E,0x64,0x3A,0x20,0x25,0x64,0xD,0xA
	.DB  0x0
__RESET:
	CLI
	CLR  R30
...
; 0000 00DD        data=EEPROM_read(2);
	...
	ST   -Y,R30
	RCALL _EEPROM_read
	STS  _data_S0000002,R30
; 0000 00DE        data1=(data&0x0f);  // 1의 자리 초
	LDI  R31,0
	ANDI R30,LOW(0xF)
	ANDI R31,HIGH(0xF)
	STS  _data1_S0000002,R30
; 0000 00DF        data2=(data&0x30);  // 10의 자리 초
	LDS  R30,_data_S0000002
	LDI  R31,0
	ANDI R30,LOW(0x30)
	ANDI R31,HIGH(0x30)
	STS  _data2_S0000002,R30
...
; 0000 00E1        h=(data2+data1);
	LDS  R26,_data2_S0000002
	CLR  R27
	LDS  R30,_data1_S0000002
	LDI  R31,0
	ADD  R30,R26
	STS  _h_S0000002,R30
; 0000 00E2 
