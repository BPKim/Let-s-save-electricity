...
; 0000 0058 // Clock value: Timer 1 Stopped
...
; 0000 005F // Timer 1 Overflow Interrupt: Off
...
; 0000 007C // Clock value: Timer 3 Stopped
; 0000 007D // Mode: Normal top=FFFFh
; 0000 007E // Noise Canceler: Off
; 0000 007F // Input Capture on Falling Edge
; 0000 0080 // OC3A output: Discon.
; 0000 0081 // OC3B output: Discon.
; 0000 0082 // OC3C output: Discon.
; 0000 0083 // Timer 3 Overflow Interrupt: Off
...
_0x3:
; 0000 00AD       {
; 0000 00AE         PORTA.0=0X01; //   릴레이1 ON
	SBI  0x1B,0
; 0000 00AF         delay_ms(500);  // 500ms delay
	RCALL SUBOPT_0x0
; 0000 00B0         PORTA.1=0X02; //   릴레이1 ON
	SBI  0x1B,1
; 0000 00B1         delay_ms(500);  // 500ms delay
	RCALL SUBOPT_0x0
; 0000 00B2         PORTA.2=0X04; //   릴레이1 ON
	SBI  0x1B,2
; 0000 00B3         delay_ms(500);   // 500ms delay
	RCALL SUBOPT_0x0
; 0000 00B4         PORTA.3=0X08; //   릴레이1 ON
	SBI  0x1B,3
; 0000 00B5         delay_ms(500);  // 500ms delay
	RCALL SUBOPT_0x0
; 0000 00B6       };
	RJMP _0x3
; 0000 00B7 }
